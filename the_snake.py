...
Реализована на принципах ООП: базовый класс GameObject
и наследники Apple, Snake.
"""
...
# Содержит 8 записей — по две на каждое текущее направление
# (исключая разворот).
DIRECTION_MAP = {
...
class GameObject:
    ...
    Содержит общие атрибуты позиции и цвета,
    а также заготовку метода отрисовки.
    """
...
def main():
    ...
    while running:
        ...
        # Если змейка сброшена (самоукус) — очистить экран
        # и перегенерировать яблоко
